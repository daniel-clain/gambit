...
export const postStartTestState = (game: Game) => {
  ...
  function quickSinisterVictory() {
    ...
    const hitman2 = new Employee("Hitman")
    const thug = new Employee("Thug")
    const thug2 = new Employee("Thug")
    const thug3 = new Employee("Thug")
    manager1?.has.employees.push(hitman, hitman2, thug, thug2, thug3)

    if (manager2) {
      manager2.has.money = 100000
      const hitman2 = new Employee("Hitman")
      const thug4 = new Employee("Thug")
      manager2.has.employees.push(hitman2, thug4)
    }
  }
  ...
  function testContractEnding() {
    ...
    game.has.weekController.jobSeekers.push({
      ...
      name: fighter2.name,
      goalContract: fighter2.state.goalContract,
    })
  }
