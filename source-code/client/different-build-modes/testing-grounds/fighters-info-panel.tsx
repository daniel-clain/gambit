...
import {
  fight,
  getProbabilities,
  setMemoryOfBehindElapsed,
  state,
  update,
} from "./probability-test-service"
              ...
              <t-row>
                ...
                <t-data>
                  <input
                    ...
                    value={
                      fighting.timers.isActive("memory of enemy behind")
                        .timeElapsed
                    }
                  />
                </t-data>
              ...
              <t-row>
                ...
                <t-data>
                  <select
                    ...
                    onChange={(e) => {
                      fighting.facingDirection = e.target
                        .value as FacingDirection
                      update()
                    }}
                  >
                    {["left", "right"].map((dir) => (
