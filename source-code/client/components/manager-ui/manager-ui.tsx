...
import './manager-ui-global-styles/manager-ui-global.scss'
import {  Employee, JobSeeker, ManagerUiState } from '../../../interfaces/game-ui-state.interface';
...
import YourFightersPanel, { YourFightersPanelProps } from './main-components/your-fighters-panel/your-fighters-panel';
import KnownFightersPanel, { KnownFightersPanelProps } from './main-components/known-fighters-panel/known-fighters-panel';
import JobSeekersPanel, { JobSeekersPanelProps } from './main-components/job-seekers-panel/job-seekers-panel';
import EmployeesPanel, { EmployeesPanelProps } from './main-components/employees-panel/employees-panel';
...
export default class ManagerUi extends React.Component<ManagerUiProps, ManagerComponentState>{
  ...
  render() {
    ...
    const { managerInfo, managerOptionsTimeLeft, jobSeekers, nextFightFighters, delayedExecutionAbilities } = this.props.managerUiState
    const { money, actionPoints, knownFighters, employees, loan, fighters, nextFightBet} = managerInfo
    const { selectedAbility, selectedEmployee, selectedJobSeeker, selectedFighter, showLoanSharkCard, bet } = this.state
          ...
          <div className='main-content'>
            ...
            <div className="two-columns">
              <div className='left-column'>
                ...
                <ActivityLogPanel log={managerInfo.activityLog}/>    
              </div>
